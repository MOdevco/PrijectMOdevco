...
const TypeDrink = () => {
  ...
  return (
    <Box>
        ...
        <Box maxWidth={'1727px'} mx={'auto'} mt={'20px'} mb={'100px'}>
            <Box>
                <Heading fontSize={'30px'}>SALQIN ICHIMLIKLAR</Heading>
            </Box>
           {!loader && <Box display={'flex'} gap={'20px'} justifyContent={'center'} minHeight={'25vh'} flexDirection={'column'}  alignItems={'center'}>
            ...
            {<Box display={'flex'} justifyContent={'space-between'} flexWrap={'wrap'} >
                {loader && data.map((item , i) => (
                    <Card width={'350px'} height={'600px'} key={i} mt={10} >
